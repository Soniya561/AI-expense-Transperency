              ...
              <div className="space-y-2">
                {suggestedQuestions.map((question, index) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-lg bg-gray-50 border border-blue-500/20 hover:border-blue-400 hover:bg-gray-100 transition-all text-sm text-black"
                  >
                    {question}
                  </button>
                ))}
