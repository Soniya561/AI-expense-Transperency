        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/30">
              ...
              <p className="text-sm text-black/70">
                Engineering department shows <span className="text-cyan-500">23% increase</span> in IT expenses due to new project tools. 
                This aligns with Q4 development sprint.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <p className="text-sm text-black/70">
                Receipt documentation rate improved to <span className="text-green-500">90%</span> from 86% last month. 
                Employee training program showing positive results.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/30">
              ...
              <p className="text-sm text-black/70">
                Average approval time is <span className="text-yellow-500">2.3 days</span>. 
                Implementing auto-approval for low-risk items could reduce this to 0.5 days.
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-black/70 mt-1">
                Based on analysis of 172 transactions, implementing automated vendor verification for purchases over $1,000 
                could reduce manual review time by approximately 40% and improve processing speed by 2.1 days on average.
              </p>
